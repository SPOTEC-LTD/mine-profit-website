export default {
  ...
  vipCouponTitle: 'e-Coupons',
  walletAccount: 'Account',
  accountAndSecurityNickName: 'Nickname',
  unSetting: 'Not set',
  logout: 'Sign Out',
  unbound: 'Not linked',
  inputInviteCodeFirstTips: 'Get MineProfit gift package worth {value}',
  ...
  accountAndSecurityGoAuth: 'Unverified',
  accountAndSecurityAuth: 'Certification',
  accountAndSecurityAuthFail: 'Authentication failed',
  accountAndSecurityAuthSuccess: 'Verified',
  logoutDialogTips: 'Are you sure want to log out of the current account?',
  ...
  tradePwdSettingTradePwdHint: 'Enter password',
  ...
  realNameAuthUpDriver: 'Upload driver license',
  name: 'Name',
  sex: 'Gender',
  nationality: 'Nationality',
  realNameAuthUpCertificatePhoto: 'ID photo',
  reUpload: 'ReUpload',
  boy: 'Male',
  girl: 'Female',
  idCard: 'ID Card',
  ...
  inviteFriendsSortIndirect: 'Indirect invite rewards',
  inviteFriendsTips: 'MineProfit will provide you a hashrate package worth {value}, Please click here to receive [{link}]',
  ...
  inStationDialogTips: 'Are you sure want to mark as all read?',
  inputInviteCodeOtherTips: 'Get newcomer gift package',
  signInRegister: 'Registration means you agree',
  homeFiledData: 'Pool Stats',
  homeMarketData: 'Markets',
  homeCurrentRate: 'Current',
  homeYesterdayOutput: 'Rev. 24h',
  homeYesterdayOutputValue: 'Conversion',
  buy: 'Buy ',
  noticeCarouselTitle: 'More',
  noticeDetailPageFAQ: 'FAQ',
  ...
  inforMaxAmount: 'Only displays at most 100 recent news',
  lookNo: '{value} views',
  getMineApp: 'Get free hashrate',
  infoScan: 'Scan to download MineProfit',
  ...
  incomeRankRule2: '2. MineProfit reserves the right of final interpretation',
  ...
  angelRankRule4: '4. MineProfit reserves the right of final interpretation',
  newBuyRankRule1: '1. Ranking based on the direct invitation rewards obtained by current customers through promotion',
  newBuyRankRule2: '2. MineProfit reserves the right of final interpretation',
  checkRewardSet: 'CHECK THE REWARD',
  allRanking: 'All ranking',
  ...
  selectPeriodsNumber: 'Select session',
  year: '{value}year',
  ranking: 'Place',
  vipHashRate: 'VIP hashrate',
  ...
  vipCouponTips: 'Be used when buying, and get extra hashrate',
  vipCouponType: 'Used/Invalid',
  vipCouponTypeOutputMost: 'Output',
  vipCouponTypeAlmostExpired: 'Expiring',
  vipCouponTypeNewCome: 'Newest',
  typeNew: 'Newest',
  typePassTime: 'Expiring',
  typeUsed: 'Used',
  vipCouponTitleOther: 'Used/Invalid',
  ...
  detail: 'Detail',
  walletSaveQRCode: 'Save',
  copySuccess: 'Copy success',
  copy: 'Copy',
  walletChargeAddress: 'Deposit address',
  withDrawChainName: 'Chain name',
  walletSelectCoinType: 'Choose coin',
  walletSelectTime: 'Select period',
  walletInWeek: 'Week',
  walletInMonth: 'Month',
  walletInThreeMonth: '3 Months',
  walletInHalfYear: 'Half year',
  to: 'to',
  ...
  activeWithDrawSubTitle: 'How to activate the withdraw function？',
  ...
  agreementViewTitle: 'MineProfit Investment Terms',
  ...
  share: 'Share',
  shareCopyPledgeLinkDes: 'I am borrowing from you through MineProfit, click to view [{link}]',
  ...
  shareCopyTransferLinkDes: 'I published a hashrate selling target in MineProfit, click to view [{link}]',
  ...
  inStationMessageDetailTitle: 'Letter details',
  allRead: 'All read',
  serviceProtocolName: 'MineProfit mining machine sharing service agreement',
  serviceProtocolDescription: "\"MineProfit Mining Machine Sharing Service Agreement\" (\"this agreement\") is a MineProfit mining machine sharing platform\n(\"MineProfit\" or \"us\" or \"company\") and the use of Mine\n   Agreement between users (\"users\" or \"you\") of the services provided by Profit and/or MineProfit's official website [MineProfit.com] (\"MineProfit website\").\n   This agreement describes the rights and responsibilities of MineProfit and users.\n   Your use of the services provided by MineProfit and/or the MineProfit website means that you agree to all the terms and conditions stipulated in this agreement. If you do not agree, please do not use the services provided by MineProfit and the MineProfit website. \"",
  serviceProtocolTitle_1: '1. Basic matters',
  serviceProtocolText_1_1: '"MineProfit reserves the right to modify the terms of this agreement at any time at its sole discretion.\r\n   You are responsible for reviewing this agreement regularly for the latest amendments.\r\n   This agreement and its amendments will take effect immediately when MineProfit publishes it on the MineProfit website\r\n   (Unless otherwise specified effective time). Your continued use of the services provided by MineProfit or the MineProfit website after the issuance of this agreement and its amendments means that you accept and agree to the amendments. "',
  serviceProtocolText_1_2: 'If you have any objections to the modification of this agreement, or are not satisfied with the services provided by MineProfit and/or the MineProfit website, you should immediately: ',
  serviceProtocolText_1_2_1: '(1) Stop using the services provided by MineProfit and the MineProfit website;',
  serviceProtocolText_1_2_2: "(2) inform MineProfit to stop the service through the customer service channel. After terminating the service, the user's right to use the MineProfit service is immediately terminated.",
  serviceProtocolTitle_2: '2. User registration',
  serviceProtocolText_2_1: "The user hereby makes the following statements and guarantees to the company, and these statements and guarantees will be deemed to be re-made each time the user uses MineProfit's services:",
  ...
  serviceProtocolText_2_1_3: "(3) The user's acceptance and use of the services provided by MineProfit complies with applicable laws, regulations and related policies in the user's country/region, and does not violate the user's obligations to any other third parties;",
  serviceProtocolText_2_1_4: '(4) The user has the right to use the services provided by MineProfit and perform related obligations, and this agreement and related service purchase orders are valid and binding on the user.',
  ...
  serviceProtocolText_2_2_2: '(2) If there is any change in the registration information that has been provided, you will promptly notify MineProfit. If the registration information you provide is illegal, untrue, inaccurate or incomplete, you shall bear all the corresponding responsibilities and consequences;',
  serviceProtocolText_2_2_3: '(3) MineProfit reserves the right to impose certain restrictions on the account and/or suspend or terminate your use of MineProfit services based on the registration information provided by you, MineProfit’s compliance obligations and internal risk control policies;',
  serviceProtocolText_2_2_4: '(4) Unless the prior written consent of MineProfit is obtained, each user can only register one account with MineProfit;',
  serviceProtocolText_2_2_5: '(5) For compliance purposes such as KYC ("Know Your Customer") and/or anti-money laundering, MineProfit has the right to ask you to provide the identification information and/or financial information of the account owner;',
  serviceProtocolText_2_2_6: '(6) You need to enter your username and password when using some specific functions in the services provided by MineProfit.\nIf you are unable to access your account due to reasons such as forgetting your password, MineProfit has the right to ask you to provide specific information including identification information, including but not limited to: identification; in order to determine the true ownership of the account;\nProof of residence;\nPhone number/email proof and any identifiable activity information on the website, such as transaction ID, order number, withdrawal amount, etc.\nYou promise that you will not share your username and/or password with others or allow any other third parties to use your account.\nMineProfit does not assume any responsibility for the improper use of your account or password by you or any other third party, as well as the consequences and losses caused.\nIf you believe that your username and/or password are known by others or your account has been used by others without authorization, you should notify MineProfit immediately.',
  ...
  serviceProtocolText_3_1_6: '(6) You understand and agree that MineProfit reserves the right to publish, modify and/or provide service-related information through websites, emails, customer service calls, SMS and other official channels. MineProfit is not responsible for information obtained through non-MineProfit official channels. If you have any questions about the authenticity of the information sent in the name of MineProfit, please contact us immediately.',
  ...
  serviceProtocolText_5_2: 'Calculation fee: The calculation fee charged by MineProfit is determined independently by MineProfit based on the current price of a specific digital currency market, future market forecasts, and calculation power decay.',
  serviceProtocolText_5_3: 'Electricity fee: The electricity fee collected by MineProfit will be used to cover: electricity fee, mining machine operation and maintenance, heat dissipation and other aspects.',
  serviceProtocolText_5_4: 'You understand and agree that: The specific package fees that MineProfit charges you are regulated by the specific service package. If you cannot accept the fees specified in a certain service package, you should not place an order with MineProfit for that service package.',
  serviceProtocolText_5_5: 'You understand and agree: As the computing power of the entire network will change, the difficulty of mining will also change accordingly. MineProfit reserves the right to adjust the package fee from time to time, but the service packages that have been sold to users before the adjustment are not affected.',
  serviceProtocolText_5_6: 'You understand and agree: The price of the mining machine sharing package is priced in US dollars. MineProfit uses the average of the real-time exchange rates published by 7 websites to convert the mining machine sharing package price into equivalent bitcoins, TEDA coins, bitcoin cash, etc. With virtual currency, users can choose to use the corresponding currency to pay. In case of abnormal exchange rate or technical failure of the exchange, MineProfit has the right to choose the exchange rate data of other exchanges. In the event of abnormal fluctuations in the Bitcoin market, MineProfit has the right to manually adjust the USD exchange rate. (The exchange rate is taken from: bitfinex, bitstamp, poloniex, kraken, investing, coinmarketcap, coinbase)',
  serviceProtocolTitle_6: '6. Service',
  serviceProtocolText_6_1: 'MineProfit is a "bridge" connecting users and several mining pools. Through the services provided by MineProfit, users can access the computing power they purchased from MineProfit to the mining pool designated by MineProfit.',
  serviceProtocolText_6_2: 'When a user connects the computing power purchased from MineProfit to a specific mining pool, the mining pool may charge the user a certain percentage of service fees, which are completely determined and collected by the mining pool independently.',
  serviceProtocolText_6_3: 'The user understands: the digital currency mined after the user connects the computing power corresponding to the purchased service package to the mining pool passes through MineProfit, and the user needs to withdraw through MineProfit to the designated digital wallet address; the user should confirm the designated digital currency by himself The wallet address is suitable for receiving the specific digital currency mined. MineProfit shall not be liable for any loss of mining revenue due to restrictions such as the upper limit on the amount of the digital currency wallet address filled in by the user for receiving revenue.',
  serviceProtocolText_6_4: 'The issuance time of the mined digital currency (if any) is based on the issuance time of the mining pool. Users understand that MineProfit is not responsible for the issuance of digital currency.',
  serviceProtocolText_6_5: 'You understand and acknowledge: MineProfit will not make any promises about your future earnings, and any future-related earnings or rate of return (or rate of return) data mentioned on the MineProfit website or MineProfit activities are estimates and assumptions. Your actual income will be affected by many factors such as the price of the digital currency market, the difficulty of the entire network, the lucky value of the mining pool, and the percentage of service fees actually charged by the mining pool.',
  serviceProtocolTitle_7: '7. Payment, cancellation, modification and refund of orders',
  serviceProtocolText_7_1: 'Users can purchase service packages using various payment methods supported by MineProfit.',
  serviceProtocolText_7_2: 'If the user chooses to use the digital currency transfer to purchase the service package: the user should transfer the digital currency to the digital currency wallet address specified by MineProfit, the specific payment amount depends on: the sum of USD orders, the exchange rate between USD and the digital currency selected for payment at the time of purchase, and Network transfer fees (third-party terms and handling fees may apply).',
  serviceProtocolText_7_3: 'If the user does not pay within a certain period of time (specifically It depends on the specific payment method) after creating the order, the status of the order will be changed to "timeout" by MineProfit. MineProfit will not process any requests related to overtime orders, and users are not obliged to pay for overtime orders.',
  serviceProtocolText_7_4: 'The user is fully responsible for the accuracy of the payment, including but not limited to: destination account address (/digital currency wallet address), transfer amount and other payment details; due to user error (such as transferring digital currency to the wrong address) Any loss caused by incorrect payment shall be borne by the user, and MineProfit reserves the right to require the user to make the correct payment before activating any service package for the user.',
  serviceProtocolText_7_5: 'If the amount actually received by MineProfit is lower than the package fee required by MineProfit, MineProfit reserves the right to determine the following matters before activating the corresponding service package:',
  serviceProtocolText_7_5_1: '(1) Adjust the service package accordingly so that the funds actually received by MineProfit match the content of the service package provided by MineProfit;',
  ...
  serviceProtocolText_7_6: 'If the amount actually received by MineProfit is higher than the service package fee required by MineProfit, the user can choose to request MineProfit:',
  serviceProtocolText_7_6_1: '(1) Adjust the service package according to the amount actually received by MineProfit;',
  serviceProtocolText_7_6_2: "(2) Add the excess amount to the user's MineProfit account balance;",
  serviceProtocolText_7_6_3: '(3) Refund the excess amount to the user through a method approved by MineProfit, provided that any additional costs (such as third-party handling fees) incurred thereby must be borne by the user.',
  serviceProtocolText_7_7: 'Due to digital currency confirmation time and third-party delays, there may be a risk that the amount transferred by users to MineProfit may be delayed.',
  serviceProtocolText_7_8: 'The user agrees and understands that without submitting a payment dispute resolution application ("Payment Dispute Resolution Application"), MineProfit has no obligation to actively resolve payment-related issues or disputes:',
  serviceProtocolText_7_8_1: "(1) The user has the right to contact MineProfit customer service within 14 days after payment and provide proof of payment that meets MineProfit's requirements to submit a payment dispute resolution application. For applications submitted after 14 days, MineProfit reserves the right to refuse to process such applications;",
  serviceProtocolText_7_8_2: "(2) If MineProfit has reasonable grounds to suspect or in fact did not receive the corresponding payment but has activated the service package for the user, BitDeer has the right to require the user to provide a proof of payment that meets the requirements of MineProfit. The user should provide proof of payment that meets MineProfit's requirements within 14 days after receiving the request;",
  serviceProtocolText_7_8_3: '(3) The payment proof includes but is not limited to: MineProfit order number, transaction ID or number, destination account (/digital currency wallet address) information entered by the user, transfer amount, and transaction records and/or transaction records of the payment system used by the user bill;',
  serviceProtocolText_7_8_4: "(4) If the user initiates a payment dispute resolution application to MineProfit, but (a) the user fails to provide proof of payment or other evidence that meets the requirements of MineProfit within 14 days, or (b) MineProfit reasonably believes that the evidence is insufficient or invalid, MineProfit reserves The right to refuse to process the user's payment dispute resolution application.",
  serviceProtocolText_7_9: "If MineProfit reasonably believes that there is a payment dispute between MineProfit and the user, MineProfit reserves the right to adjust or cancel the relevant service package and/or adjust the user's account balance in MineProfit.",
  serviceProtocolText_7_10: 'To the maximum extent permitted by laws and regulations, the user acknowledges: Unless otherwise expressly agreed in writing, all purchased service packages are final purchases and cannot be replaced and refunded. MineProfit reserves the right to determine refunds on its own: If MineProfit decides to provide refunds to individual users or specific service packages, it does not mean that MineProfit is obliged to agree to the same or similar refunds in the future. This refund policy does not affect any statutory rights that may apply.',
  ...
  serviceProtocolText_7_12: 'Subject to other provisions of this agreement, if MineProfit provides a refund in accordance with this agreement or applicable laws and regulations, any additional costs (such as third-party handling fees) incurred shall be entirely borne by the user.',
  ...
  serviceProtocolText_8_1: 'You must not use the services provided by MineProfit to engage in any illegal activities. You must not use the services provided by MineProfit:',
  ...
  serviceProtocolText_8_2: 'You agree to abide by all applicable laws and regulations, this agreement and all rules and policies related to the use of the MineProfit website and the services provided by MineProfit announced by MineProfit from time to time.',
  serviceProtocolText_8_3: 'You agree that you shall fully assume the relevant tax obligations arising from the use of the services provided by MineProfit.',
  serviceProtocolText_8_4: 'You agree and promise that you are only using the services provided by MineProfit for your own benefit, and you have not used the services provided by MineProfit on behalf of others or for the benefit of other third parties.',
  serviceProtocolText_8_5: 'You agree to contact MineProfit immediately when you discover or suspect any fraud or misconduct in the use of services provided by MineProfit by any third party.',
  serviceProtocolText_8_6: 'Unless MineProfit expressly agrees in writing in advance, you may not register multiple accounts on the MineProfit website in any way. You may not register multiple accounts to earn profits, rewards or coupons.',
  serviceProtocolText_8_7: 'You should not participate in any activities that may affect the services provided by MineProfit and/or the safety of the MineProfit website.',
  ...
  serviceProtocolText_8_9: "The intellectual property rights of any content displayed on the MineProfit website, including but not limited to articles, pictures, news, materials, website structure, website layout, website design, unless otherwise specified, shall be fully owned by MineProfit or MineProfit’s licensors (if any) have. Users should respect the intellectual property rights of MineProfit and MineProfit's licensors (if any).",
  serviceProtocolText_8_10: 'Without the prior written authorization of MineProfit, users are not allowed to conduct any activities and use the information/data on the MineProfit website in the name of MineProfit.',
  serviceProtocolText_8_11: "You hereby promise and guarantee that your use of the services provided by MineProfit will not negatively affect MineProfit's reputation or cause MineProfit to bear legal liabilities or other penalties, fines and sanctions.",
  serviceProtocolText_8_12: 'Users understand that MineProfit’s services are not open to residents in the following countries or regions: Balkans, Belarus, Myanmar, Côte d’Ivoire (Ivory Coast), Crimea-Ukraine, Cuba, Congo Main Republic, Iran, Iraq, Liberia, North Korea , Sudan, Syria, Venezuela, Zimbabwe The above list may not be exhaustive. Before using the services provided by MineProfit, please confirm that your use of the services provided by MineProfit is legal in your country/region. All legal risks and liabilities caused by the illegal use of the services provided by MineProfit in your country/region will be solely borne by you.',
  serviceProtocolText_8_13: 'If the user violates the provisions of this Article 8, MineProfit has the right to immediately suspend or terminate the provision of services to the user, and has the right to take all necessary legal measures within the scope permitted by applicable laws and regulations.',
  serviceProtocolTitle_9: '9. Liability for breach of contract',
  serviceProtocolText_9_1: "For any user's violation of this agreement (including but not limited to: the user fails to pay the package fee in time, the user's use of the service provided by MineProfit is illegal in the user's country/region, etc.), MineProfit has the right to immediately suspend or terminate the provision of services to the user. Take all necessary legal measures within the scope permitted by applicable laws and regulations, including but not limited to requiring users to compensate MineProfit for related losses.",
  serviceProtocolText_9_2: 'If MineProfit reasonably suspects that the user has used the services provided by MineProfit in an illegal, fraudulent or other improper manner, MineProfit has the right to suspend the provision of services to the user until the user can provide a compliance certificate that meets the requirements of MineProfit.',
  serviceProtocolTitle_10: '10. Limitation of Liability',
  serviceProtocolText_10_1: 'The service package provided by MineProfit corresponds to real computing power. You understand and agree that: fluctuations in real computing power are inevitable, and MineProfit does not guarantee 100% stable operation of the computing power corresponding to the service package. Except for the following situations, most of the cases where computing power performance fluctuates (including but not limited to: digital currency price fluctuations, changes in the inherent properties of digital currencies, the difficulty of the entire network, the lucky value of the mining pool, the percentage of service fees charged by the mining pool, etc. (Service package income fluctuations caused by many factors) MineProfit will not compensate.',
  serviceProtocolText_10_2: 'MineProfit shall not be liable for service interruption or termination due to circumstances beyond its control, including but not limited to war (declared or undeclared), terrorist activities, sabotage, blockade, fire, lightning, natural disasters, strikes, riots , Riots, civil unrest, epidemic prevention restrictions, epidemics, earthquakes, floods, hurricanes, explosions, and regulatory and administrative actions or delays. In the event of such force majeure, MineProfit shall take reasonable measures to minimize the interference and loss, but shall not be liable for the consequences or incidental consequences caused by such force majeure.',
  serviceProtocolText_10_3: "The user agrees: Any third-party links provided by MineProfit are only for convenience and reference. The provision of such third-party links by MineProfit does not mean that it confirms such links and the content displayed on such links. Since such third-party links are not controlled by MineProfit, MineProfit cannot guarantee that users' access to such links is safe and virus-free. MineProfit is not responsible for any loss caused by the user's access to such third-party links and any other third-party links not controlled by MineProfit.",
  serviceProtocolText_10_4: 'The user understands and agrees: Unless MineProfit expressly agrees in writing in advance, under any circumstances, MineProfit will not be liable for the following matters and the losses caused by the user due to the following matters:',
  serviceProtocolText_10_4_1: '(1) Loss of trading profits;',
  serviceProtocolText_10_4_2: "(2) Service interruption (such interruption is not caused by MineProfit's deliberate misconduct);",
  serviceProtocolText_10_4_3: "(3) Damage or loss of information/data not caused by MineProfit's deliberate misconduct;",
  ...
  serviceProtocolText_10_4_6: "(6) Losses caused by the user's fault or violation of this agreement (including but not limited to: providing inaccurate information to MineProfit, leaking passwords to third parties, etc.);",
  serviceProtocolText_10_4_7: '(7) Other events not controlled by MineProfit.',
  ...
  serviceProtocolText_10_6: "The user agrees: MineProfit's full responsibility to the user under this agreement shall not exceed the total package fee paid by the user to MineProfit.",
  ...
  privacyProtocolDescription: "I would like to remind you (user) to read this \"User Agreement\" (hereinafter referred to as the \"Agreement\") carefully before registering as a user to ensure that you fully understand the terms of this agreement. Please read carefully and choose to accept or not accept this agreement. Your registration, login, use, etc. will be regarded as acceptance of this agreement, and you agree to be bound by the terms of this agreement. This agreement stipulates the rights and obligations between MineProfit and the user regarding the \"Profit Computing\" software service (hereinafter referred to as the \"Service\"). \"Users\" refer to individuals who register, log in, and use this service. This agreement can be updated by MineProfit at any time. Once the updated agreement terms are announced, they will replace the original agreement terms without further notice. Users can check the latest version of the agreement terms in this APP. After modifying the terms of the agreement, if the user does not accept the modified terms, please stop using the service provided by MineProfit immediately, and the user's continued use of the service will be deemed to have accepted the modified agreement.",
  privacyProtocolTitle_1: '1. Account registration',
  privacyProtocolText_1_1: 'Users need to register a "MineProfit" account before using this service. The "MineProfit" account should be registered with the mobile phone number binding. Users are requested to register the "MineProfit" account with a mobile phone number that has not been bound to the "MineProfit" account, and a mobile phone number that has not been blocked by the service according to this agreement. The service can change the way of account registration and binding according to user needs or product needs, without the need to notify users in advance.',
  privacyProtocolText_1_2: "When registering, users should authorize MineProfit and use their personal information to successfully register a \"MineProfit\" account. Therefore, the user's completion of registration means that the user agrees to the service to extract, disclose and use the user's information.",
  privacyProtocolText_1_3: 'In view of the binding registration method of the "MineProfit" account, you agree that the service will allow your mobile phone number and mobile device identification code to be used for registration when registering.',
  privacyProtocolText_1_4: "When users register and use the service, MineProfit needs to collect personal information that can identify the user so that the service can contact the user when necessary, or provide the user with a better experience. The information collected by MineProfit includes but is not limited to the user's name and address; MineProfit agrees that the use of this information will be subject to the restrictions of the third user's personal privacy information protection.",
  privacyProtocolTitle_2: '2. User personal privacy information protection',
  privacyProtocolText_2_1: 'If MineProfit finds or receives reports or complaints from others that the user violates the provisions of this agreement, MineProfit has the right to review and delete relevant content, including but not limited to user information, posting records, and to account for violations based on the severity of the circumstances. Penalties including but not limited to warnings, account bans, device bans, and function bans will be imposed, and the user will be notified of the processing results.',
  privacyProtocolText_2_2: 'Users who are banned for violating the user agreement can contact MineProfit by themselves. Among them, users who have been banned by the function will automatically restore the banned function after the ban period expires. The blocked user can submit an appeal, and MineProfit will review the appeal and make a reasonable judgment on its own to decide whether to change the punishment measures.',
  privacyProtocolText_2_3: 'The user understands and agrees that MineProfit has the right to penalize violations of relevant laws and regulations or the provisions of this agreement based on reasonable judgments, take appropriate legal actions against any user who violates laws and regulations, and save relevant information in accordance with laws and regulations to report to relevant departments, etc., The user shall bear all legal responsibilities arising therefrom.',
  privacyProtocolText_2_4: 'The user understands and agrees that for any claims, demands or losses claimed by any third party, including reasonable attorney fees, caused or caused by the user’s violation of this agreement, the user shall compensate MineProfit and its partner companies and affiliated companies and protect them from damage.',
  ...
  privacyProtocolText_3_2: 'Users are not allowed to use the "MineProfit" account or this service to produce, upload, copy, publish, or disseminate content prohibited by the following laws, regulations and policies:',
  ...
  privacyProtocolText_3_3: 'Users shall not use the "MineProfit" account or this service to produce, upload, copy, publish, or disseminate the following content that interferes with the normal operation of the "service" and infringes the legitimate rights and interests of other users or third parties:',
  ...
  privacyProtocolText_4_1: "Any content transmitted or published by users in or through this service does not reflect or represent, nor should it be deemed to reflect or represent MineProfit's views, positions or policies, and MineProfit assumes no responsibility for this.",
  privacyProtocolText_4_2: 'Users are not allowed to use the "MineProfit" account or this service to do the following:',
  ...
  privacyProtocolText_4_2_5: '(5) Use the "MineProfit" account or this service to engage in any illegal or criminal activity;',
  ...
  privacyProtocolText_4_2_7: '(7) Other acts that violate laws and regulations, infringe on the legitimate rights and interests of other users, interfere with the normal operation of "MineProfit" or services without express authorization.',
  privacyProtocolText_4_3: 'The user shall be solely responsible for the authenticity, legality, harmlessness, accuracy, and effectiveness of the information transmitted using the "MineProfit" account or this service. Any legal responsibility related to the information disseminated by the user shall be borne by the user. MineProfit has nothing to do. If this causes damage to MineProfit or a third party, the user shall compensate according to law.',
  privacyProtocolText_4_4: 'The services provided by MineProfit may include advertisements, and the user agrees to display advertisements provided by MineProfit and third-party suppliers and partners during use. Except as clearly provided by laws and regulations, users shall be responsible for transactions based on the advertising information, and MineProfit shall not be liable for any loss or damage suffered by users due to transactions based on the advertising information or the content provided by the aforementioned advertisers.',
  privacyProtocolTitle_5: '5. Other',
  privacyProtocolText_5_1: 'MineProfit solemnly reminds users to pay attention to the clauses in this agreement that exempt MineProfit from liability and limit user rights, please read carefully and consider the risks independently. Minors should read this agreement accompanied by a legal guardian.',
  privacyProtocolText_5_2: "The validity, interpretation and dispute resolution of this agreement are applicable to the laws of the People's Republic of China. If any dispute or dispute occurs between the user and MineProfit, it should be settled through friendly negotiation. If the negotiation fails, the user agrees to submit the dispute or dispute to the jurisdiction of the people's court with jurisdiction in the place where MineProfit resides.",
  ...
  privacyProtocolFooterText: 'The copyright of this "Agreement" is owned by MineProfit, and MineProfit reserves all rights to interpret this "Agreement".',
  investProtocolName: 'MineProfit Investment Invitation Terms',
  ...
  investProtocolText_1_1: 'Investor: A natural person who is invited by the invitee and helps the inviter to purchase the corresponding amount of standard computing power in MineProfit financially.',
  ...
  investProtocolText_2_1: 'The pledged computing power is the pledge subject of this agreement, which is the computing power and derived rights and interests enjoyed by investors in MineProfit.',
  ...
  investProtocolTitle_9_4_2: '(2) MineProfit has the right to advance the liquidation of the pledged computing power of the inviter, the liquidation proceeds and priority repayment to investors, as well as payment as liquidated damages, if there is the remaining part, it will continue to return to the inviter.',
  ...
  basicIntroduce: 'MineProfit is the world first hash rate exchange platform. The major function for MineProfit is to organise Standard Hash ® from hash rate providers (electricity providers, mining companies, mining machine providers) and distribute the Standard Hash ® to the market. Users can buy and sell and pledge Standard Hash ® on the platform.',
  ...
  pleaseEnterPhoneNumber: 'Please insert cell phone number',
  emailAddress: 'Email address',
  emailAddressRequire: 'Email address cannot be empty',
  pleaseEnterEmailAddress: 'Please enter email adress',
  ...
  idNumberRequire: 'ID number cannot be empty',
  addressRequire: 'Current address cannot be empty',
  noUploadImage: "Haven't upload ID photo",
  videoAuthPrompt2: 'Read the certification numbers within 10 seconds',
  noUploadVideo: "Haven't uploaded the video",
  uploadFailed: 'Upload failed',
  month: 'Month',
  browserShareCurrentPage: 'Share this page via browser',
  qrCodeScreenshotShare: 'Share the screenshot of the QR code',
  setSuccessfully: 'Set successfully',
  hashRateProduct: 'Hashrate',
  accountSetting: 'Account',
  newUserUsed: 'New clients',
  homeDownloadApp: 'Download',
  vipExclusive: 'VIP',
  vipHashrateUsed: 'FREE HASHRATE FOR YOU',
  hashRateMarket: 'Market',
  announcementDetail: 'Details',
  emailWrongFormat: 'Email format error',
  linkToPageInTime: 's return to',
  ...
  needBindPhone: 'The phone number you want to bind',
  fillReceivedPhoneVerificationCode: 'Please fill in the mobile phone verification code you received',
  emailAddressWrongFormat: 'Email address format is wrong',
  bindPhone: 'Link Phone',
  uploadSuccessClickReUpload: 'Upload successfully click to re-upload',
  videoAuthPrompt1: 'Please hold your ID card to record the video',
  clickUploadVideo: 'Click to upload video',
  uploadImage: 'Please upload image',
  bindEmail: 'Link Email',
  accountAndSetting: 'Account',
  ...
  withDrawMinNumber: 'Minimum withdrawal amount:',
  countryCodeSelectArea: 'Area',
  marketBuyPart: 'Number of packages',
  realNameFamilyHint: 'Please enter your surname which display on your ID card',
  givenName: 'First name',
  givenNameRequire: 'Given name cannot be empty',
  realNameGivenHint: 'Please enter your given name which display on your ID card',
  familyName: 'Last name',
  familyNameRequire: 'Surname cannot be empty',
  ...
  moreThan: 'more than',
  mpUsers: 'MineProfit users',
  miningCycle: 'Mining Cycle',
  weeklyOutputIncome: 'Weekly Mining Value',
  congratulations: 'Congratulations',
  infinity: 'Infinite',
  openApplication: 'Open MineProfit, get free hashrate',
  preSaleNow: 'In Presale',
  preSale: 'Presale',
  preSaleTime: 'Presale Time',
  start: 'Start',
  httpError503: 'System is upgrading, please try again later',
  onlineSaleTime: '{time} Public Offering',
  openRightNow: 'Open Now',
  notDownload: 'Not Download Yet',
  needAccess: 'This function requires access to the MineProfit App',
  ...
  iconRuleText1: 'Invite friends to sign up for MineProfit',
  ...
  completed: 'Finished',
  viewRulesDetail: 'View rule details',
