/* eslint-disable */
export default {
  "searchInputPlaceholder": "Search for the question you want to ask",
  "search": "Search for",
  ...
  "yesterdayProducer": "Yesterday's output",
  ...
  "basicIntroduce": "Mineprofit is a decentralized hashrate investment platform invested by Mineprofit, an international crypto asset investment management company registered in Seychelles.",
  "secondParagraphIntroduce": "Ordinary people are difficult to join the ranks of cryptocurrency miners due to technical restrictions on mining sites, power resources, and computer hardware operation and maintenance.\n    But the profitability has made ordinary people realize the dream of a miner. The cloud hosting technology of Yinghash allows miners to purchase hashrate directly from Yinghash for mining without having to undertake any operation and maintenance of mining machines, which effectively reduces the investment threshold for users.",
  "thirdlyParagraphIntroduce": "Mineprofit has more than ten years of investment background in power stations all over the world. Therefore, unlike ordinary digital mining, Yingbaili cooperates with power stations with surplus power and local electric companies around the world to build and integrate medium-sized digital mines.\n    Equipped with a smart electricity price billing model, and through the payment of dividends to investors and power providers to achieve a true win-win goal.",
  ...
  "cloudHostingTechnology": "Cloud hosting technology",
  "solveThresholdProblem": "Solve the mining threshold problem",
  "smartElectricityPrice": "Smart discount electricity price",
  "lowerMinerCosts": "Effectively reduce mining costs",
  "pledgeFree": "Free hashrate pledge",
  "improveMiningEfficiency": "Significantly increase mining revenue",
  "investmentAssetProtection": "Investment asset protection",
  "ensureAssetsSafety": "Ensure the safety of miners' assets",
  "hashRateTradingMarkets": "Hash power trading market",
  "finishSalesEssay": "Easily realize the trading of hashrate",
  "essayHashRate": "Profitability",
  "companyBackground": "Mineprofit has more than ten years of investment background in power stations all over the world.",
  ...
  "purchaseCloudHashRate": "Buy cloud hashrate",
  "freeTradingByOfficialMarket": "Freely trade with the C2C market through the official market",
  ...
  "profitOfMining": "Mining output income",
  ...
  "sorryPageMeetsError": "Sorry, the page you visited is wrong",
  ...
  "home": "Home page",
  "newsAnnouncement": "Information Announcement",
  ...
  "downloadTitle3": "Professional data to help you win",
  ...
  "testInviterPledge": "Cycle testing invites to pledge hashrate value",
  ...
  "returnHashRate": "Hash power return to inviter",
